...
public class LocalDataSender {
	...
	public int sendLoginout() {
		...
		if (ClientCoreSDK.getInstance().isLoginHasInit()) {
			byte[] b = ProtocolFactory.createPLoginoutInfo(ClientCoreSDK.getInstance().getCurrentLoginInfo().getLoginUserId()).toBytes();
	...
	int sendKeepAlive() {
		byte[] b = ProtocolFactory.createPKeepAlive(ClientCoreSDK.getInstance().getCurrentLoginInfo().getLoginUserId()).toBytes();
	...
	public int sendCommonData(String dataContentWidthStr, String to_user_id,boolean QoS, String fingerPrint, int typeu) {
		return sendCommonData(ProtocolFactory.createCommonData(dataContentWidthStr, ClientCoreSDK.getInstance().getCurrentLoginInfo().getLoginUserId(), to_user_id, QoS, fingerPrint, typeu));
	}
	...
	public static abstract class SendCommonDataAsync extends SwingWorker<Integer, Object> {
		...
		public SendCommonDataAsync(String dataContentWidthStr, String to_user_id, String fingerPrint, int typeu) {
			this(ProtocolFactory.createCommonData(dataContentWidthStr, ClientCoreSDK.getInstance().getCurrentLoginInfo().getLoginUserId(), to_user_id, true, fingerPrint, typeu));
		}
